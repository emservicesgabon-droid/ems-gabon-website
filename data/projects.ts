...
export const projects: Project[] = [
  {
    ...
    image: "/images/projects/sage100-gabon.webp",
    featured: true,
  },
  {
    id: "2",
    ...
    image: "/images/projects/reseau-impots.webp",
    featured: true,
  },
  {
    id: "3",
    title: "Vidéosurveillance – C.H.U d'Owendo",
    titleEn: "Video Surveillance – Owendo University Hospital",
    client: "C.H.U d'OWENDO",
    category: "security",
    problem: "Site hospitalier étendu à sécuriser : accès multiples, zones sensibles et flux continu de personnes à surveiller.",
    problemEn: "A large hospital site to secure: multiple entry points, sensitive areas and a constant flow of people to monitor.",
    solution: "Installation de caméras IP HD, système anti-intrusion, contrôle d'accès badgé et supervision centralisée 24/7 des bâtiments.",
    solutionEn: "Installation of HD IP cameras, an anti-intrusion system, badge access control and centralized 24/7 building supervision.",
    result: "Surveillance continue des accès et des zones sensibles, meilleure protection du personnel, des patients et des équipements.",
    resultEn: "Continuous monitoring of entry points and sensitive areas, improved protection of staff, patients and equipment.",
    tags: ["Caméras IP", "Anti-intrusion", "Contrôle d'accès"],
    image: "/images/projects/videosurveillance-chu-owendo.webp",
    featured: true,
  },
  {
    id: "4",
    ...
    image: "/images/projects/formation-lycee.webp",
  },
  {
    id: "5",
    ...
    image: "/images/projects/fibre-logistique.webp",
  },
  {
    id: "6",
    ...
    image: "/images/projects/portail-palmiers.webp",
  },
];
