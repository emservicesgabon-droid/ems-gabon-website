      ...
      <section className="py-16 sm:py-20 bg-[#0b1c2e]">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            {/* Form */}
            <div className="lg:col-span-2 bg-white/[0.04] rounded-2xl border border-white/10 p-6 sm:p-8">
            ...
            <div className="flex flex-col gap-5">
                  ...
                  {channels.map(({ icon: Icon, label, value, href, color, bg, external }) => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-sm font-medium text-text-heading group-hover:text-[#8eeeff] transition-colors">
                          {value}
                        </div>
                      </div>
                    </a>
              ...
              <div className="bg-white/[0.04] rounded-xl border border-white/10 p-5">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    <Clock size={16} className="text-[#00d4ff] mt-0.5 flex-shrink-0" />
              ...
              {/* Map placeholder */}
              <div className="bg-[#00d4ff]/12 rounded-xl border border-white/10 h-48 flex flex-col items-center justify-center gap-2">
                <MapPin size={28} className="text-[#00d4ff]" />
                <p className="text-sm font-medium text-[#00d4ff]">{t("contact.map_title")}</p>
                <p className="text-xs text-[#00d4ff]">Libreville, Gabon</p>
              </div>
            </div>
          </div>
        </Container>
